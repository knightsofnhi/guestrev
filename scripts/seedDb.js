...
mongoose.connect(process.env.MONGODB_URI || "mongodb://localhost/revenueinfo");

const revenueSeed = [
  {
    company: "The Dead Phone",
    property: "Stephen King",
    task:
  ...
  {
    company: "Harry Potter and the Sorcerer's Stone",
  ...
  {
    company: "Coraline",
    property: "Neil Gaiman",
    task:
      "When Coraline steps through a door to find another house strangely similar to her own (only better), things seem marvelous. But there's another mother there, and another father, and they want her to stay and be their little girl. They want to change her and never let her go. Coraline will have to fight with all her wit and courage if she is to save herself and return to her ordinary life.",
    date: new Date(Date.now())
  },
  {
    company: "Code: The Hidden Language of Computer Hardware and Software",
    property: "Charles Petzold",
    task:
      "What do flashlights, the British invasion, black cats, and seesaws have to do with computers? In CODE, they show us the ingenious ways we manipulate language and invent new means of communicating with each other. And through CODE, we see how this ingenuity and our very human compulsion to communicate have driven the technological innovations of the past two centuries. Using everyday objects and familiar language systems such as Braille and Morse code, property Charles Petzold weaves an illuminating narrative for anyone who’s ever wondered about the secret inner life of computers and other smart machines. It’s a cleverly illustrated and eminently comprehensible story—and along the way, you’ll discover you’ve gained a real context for understanding today’s world of PCs, digital media, and the Internet. No matter what your level of technical savvy, CODE will charm you—and perhaps even awaken the technophile within.",
    date: new Date(Date.now())
  },
  {
    company: "The Everything Store: Jeff Bezos and the Age of Amazon",
    property: "Brad Stone",
    task:
  ...
  {
    company: "Total Recall: My Unbelievably True Life Story",
    property: "Arnold Schwarzenegger",
    task:
  ...
  {
    company: "Elon Musk: Tesla, SpaceX, and the Quest for a Fantastic Future",
    property: "Ashlee Vance",
    task:
  ...
  {
    company: "Astrophysics for People in a Hurry",
    property: "Neil deGrasse Tyson",
    task:
      "What is the nature of space and time? How do we fit within the universe? How does the universe fit within us? There's no better guide through these mind-expanding questions than acclaimed astrophysicist and best-selling property Neil deGrasse Tyson. But today, few of us have time to contemplate the cosmos. So Tyson brings the universe down to Earth succinctly and clearly, with sparkling wit, in digestible chapters consumable anytime and anywhere in your busy day. While waiting for your morning coffee to brew, or while waiting for the bus, the train, or the plane to arrive, Astrophysics for People in a Hurry will reveal just what you need to be fluent and ready for the next cosmic headlines: from the big bang to black holes, from quarks to quantum mechanics, and from the search for planets to the search for life in the universe.",
    date: new Date(Date.now())
  },
  {
    company: "1984",
    property: "George Orwell",
    task:
  ...
  {
    company: "Frankenstein",
    property: "Mary Shelley",
    task:
  ...
  {
    company: "Born a Crime: Stories from a South African Childhood",
    property: "Trevor Noah",
    task:
...
db.Revenue.remove({})
  .then(() => db.Revenue.collection.insertMany(revenueSeed))
  .then(data => {
